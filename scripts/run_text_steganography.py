"""Text steganography demonstration using arithmetic coding and language models.

Demonstrates encoding and decoding a secret text message into cover text
using GPT-2 with arithmetic coding, Huffman coding, or binning baselines.
"""

import math
import bitarray

from src.utils import get_model, encode_context
from src.arithmetic import encode_arithmetic, decode_arithmetic
from archive.block_baseline import get_bins, encode_block, decode_block
from archive.huffman_baseline import encode_huffman, decode_huffman
from archive.sample import sample
